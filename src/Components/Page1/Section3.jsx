const Section3 = () => {
    return (
        <div className="section3 container mb-5 px-2">
            <div className="d-flex justify-content-between ">
                <div className="bannerSecondHeader">
                    <h4 className="card-body">Consult top doctors online for any health concern</h4>
                    <p className="card-body">
                        Private online consultations with verified doctors in all
                        specialists.
                    </p>
                </div>
                <div className="bannerSecondBtn">
                    <button className="btn btn-outline-info">View all Specilities</button>
                </div>
            </div>
